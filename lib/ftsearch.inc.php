...
$ftsearch_simplerules[] = ['qu', 'k'];
$ftsearch_simplerules[] = ['ts', 'z'];
$ftsearch_simplerules[] = ['tz', 'z'];
$ftsearch_simplerules[] = ['alp', 'alb'];
$ftsearch_simplerules[] = ['y', 'i'];
$ftsearch_simplerules[] = ['ai', 'ei'];
$ftsearch_simplerules[] = ['ou', 'u'];
$ftsearch_simplerules[] = ['th', 't'];
$ftsearch_simplerules[] = ['ph', 'f'];
$ftsearch_simplerules[] = ['oh', 'o'];
$ftsearch_simplerules[] = ['ah', 'a'];
$ftsearch_simplerules[] = ['eh', 'e'];
$ftsearch_simplerules[] = ['aux', 'o'];
$ftsearch_simplerules[] = ['eau', 'o'];
$ftsearch_simplerules[] = ['eux', 'oe'];
$ftsearch_simplerules[] = ['^ch', 'sch'];
$ftsearch_simplerules[] = ['ck', 'k'];
$ftsearch_simplerules[] = ['ie', 'i'];
$ftsearch_simplerules[] = ['ih', 'i'];
$ftsearch_simplerules[] = ['ent', 'end'];
$ftsearch_simplerules[] = ['uh', 'u'];
$ftsearch_simplerules[] = ['sh', 'sch'];
$ftsearch_simplerules[] = ['ver', 'wer'];
$ftsearch_simplerules[] = ['dt', 't'];
$ftsearch_simplerules[] = ['hard', 'hart'];
$ftsearch_simplerules[] = ['egg', 'ek'];
$ftsearch_simplerules[] = ['eg', 'ek'];
$ftsearch_simplerules[] = ['cr', 'kr'];
$ftsearch_simplerules[] = ['ca', 'ka'];
$ftsearch_simplerules[] = ['ce', 'ze'];
$ftsearch_simplerules[] = ['x', 'ks'];
$ftsearch_simplerules[] = ['ve', 'we'];
$ftsearch_simplerules[] = ['va', 'wa'];
