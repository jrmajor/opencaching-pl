...
<table width="100%" style="line-height: 1.6em; font-size: 12px;">
  <tr>
    <td colspan="3" style="text-align: center;"><b>{{ranking_by_number_of_created_active_caches}}</b></td>
  </tr>
  <tr>
    <td colspan="3" style="text-align: center;">{{users_who_created_caches_active}}: <?=$userscount?><br>{{number_of_active_caches}}: <?=$cachescount?></td>
  </tr>
  <tr class="bgcolor2">
