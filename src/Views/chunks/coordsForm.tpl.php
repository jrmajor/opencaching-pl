...
return function (Coordinates $initCoords = null, $inputPrefix='') {
    ...
    [$latLetter, $latDeg, $latMin] = ($initCoords)?$initCoords->getLatitudeParts($f):[$defaultLat, '', ''];
    [$lonLetter, $lonDeg, $lonMin] = ($initCoords)?$initCoords->getLongitudeParts($f):[$defaultLon, '', ''];
